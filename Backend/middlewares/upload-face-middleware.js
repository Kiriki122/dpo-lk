...
const { z } = require("zod");
const { UploadFaceRequestSchema } = require("../service/validation/upload-face-request.schema");
...
const handleUploadFaceFile = (req, res, next) => {
...
module.exports = handleUploadFaceFile;
